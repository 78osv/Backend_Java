...
import ru.olgavakula.dto.PostImageResponse;
...
import static ru.olgavakula.Endpoints.UPLOAD_IMAGE;
...
public class ImageTests extends BaseTest {
    ...
    void beforeTest() {
        ...
        multiPartSpecWithFile = new MultiPartSpecBuilder(new File("src/test/resources/fruits.jpeg"))
                .controlName("image")
                .build();
